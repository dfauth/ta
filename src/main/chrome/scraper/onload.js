function extractMktDepth() {
  ...
  var data = JSON.stringify({ 'buyers':buyers, 'buyerShares':buyerShares, 'sellers':sellers, 'sellerShares':sellerShares, 'price':parseFloat(price), 'change':parseFloat(change) });
