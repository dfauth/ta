...
import static com.github.dfauth.ta.model.txn.TxnEntry.TxnType.*;
...
//        ID(v -> v, (b,o) -> b.id((String)o)),
    ...
    public enum TxnType {
        ...
        DEP(TxnEntry::parseDepositString),  // deposit
        CREDIT(TxnEntry::parseCreditString),  // credit
        INT(TxnEntry::parseInterestString), // interest
        DIV(TxnEntry::parseDividendString), // dividend
        OTHER(TxnEntry::parseOtherString);
...
//        return new Interest(e.date, e.detail, e.credit.orElse(ZERO), e.balance);
...
//        return new Credit(e.date, e.detail, contractNo, e.credit, e.balance);
...
//            return new Deposit(e.date, e.detail, "ASX:"+code, contractNo, e.credit, e.balance);
...
//        return new Other(e.date, e.detail, e.credit, e.balance);
...
//        return new DividendPayment(e.date, e.detail, "ASX:"+code, contractNo, e.credit, e.balance);
...
//                result = new SecuritiesPurchase(e.date, e.detail, side, "ASX:"+code, contractNo, e.debit, e.balance);
